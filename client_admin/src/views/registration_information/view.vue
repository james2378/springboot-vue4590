	...
	<el-main class="bg edit_wrap">
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
				...
				<el-form-item label="运动员账号" prop="athlete_account">
							...
							<!--v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','athlete_account')) || (!form['registration_information_id'] && $check_field('add','athlete_account'))" :disabled="disabledObj['athlete_account_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','athlete_account')">{{form['athlete_account']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','athlete_account')) || (!form['registration_information_id'] && $check_field('add','athlete_account'))" id="athlete_account" v-model="form['athlete_account']" :disabled="disabledObj['athlete_account_isDisabled']">
				...
				<el-form-item label="运动员" prop="athletes">
							  ...
							  v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','athletes')) || (!form['registration_information_id'] && $check_field('add','athletes'))" :disabled="disabledObj['athletes_isDisabled']"></el-input>
				...
				<el-form-item label="性别" prop="gender">
							  ...
							  v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','gender')) || (!form['registration_information_id'] && $check_field('add','gender'))" :disabled="disabledObj['gender_isDisabled']"></el-input>
				...
				<el-form-item label="年龄" prop="age">
						...
						v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','age')) || (!form['registration_information_id'] && $check_field('add','age'))" :disabled="disabledObj['age_isDisabled']"></el-input-number>
				...
				<el-form-item label="项目编号" prop="project_number">
							  ...
							  v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','project_number')) || (!form['registration_information_id'] && $check_field('add','project_number'))" :disabled="disabledObj['project_number_isDisabled']"></el-input>
				...
				<el-form-item label="项目名称" prop="entry_name">
							  ...
							  v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','entry_name')) || (!form['registration_information_id'] && $check_field('add','entry_name'))" :disabled="disabledObj['entry_name_isDisabled']"></el-input>
				...
				<el-form-item label="比赛分类" prop="competition_classification">
							  ...
							  v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','competition_classification')) || (!form['registration_information_id'] && $check_field('add','competition_classification'))" :disabled="disabledObj['competition_classification_isDisabled']"></el-input>
				...
				<el-form-item label="比赛时间" prop="competition_time">
								<el-date-picker :disabled="disabledObj['competition_time_isDisabled']" v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','competition_time')) || (!form['registration_information_id'] && $check_field('add','competition_time'))" id="competition_time"
				...
				<el-form-item label="裁判账号" prop="referee_account">
													<el-select v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','referee_account')) || (!form['registration_information_id'] && $check_field('add','referee_account'))" id="referee_account" v-model="form['referee_account']" :disabled="disabledObj['referee_account_isDisabled']">
				...
				<el-form-item label="裁判姓名" prop="referee_name">
							  ...
							  v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','referee_name')) || (!form['registration_information_id'] && $check_field('add','referee_name'))" :disabled="disabledObj['referee_name_isDisabled']"></el-input>
				...
				<el-form-item label="报名人数" prop="number_of_applicants">
						...
						v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','number_of_applicants')) || (!form['registration_information_id'] && $check_field('add','number_of_applicants'))" :disabled="disabledObj['number_of_applicants_isDisabled']"></el-input-number>
					<div v-else-if="$check_field('get','number_of_applicants')">{{form['number_of_applicants']}}</div>
							</el-form-item>
			</el-col>
								<el-col v-if="user_group === '管理员' || $check_field('get','information_remarks') || $check_field('add','information_remarks') || $check_field('set','information_remarks')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="信息备注" prop="information_remarks">
								<el-input type="textarea" id="information_remarks" v-model="form['information_remarks']" placeholder="请输入信息备注"
						v-if="user_group === '管理员' || (form['registration_information_id'] && $check_field('set','information_remarks')) || (!form['registration_information_id'] && $check_field('add','information_remarks'))" :disabled="disabledObj['information_remarks_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','information_remarks')">{{form['information_remarks']}}</div>
							</el-form-item>
			</el-col>
			...
			return {
				...
				disabledObj:{
								"athlete_account_isDisabled": false,
										...
										"information_remarks_isDisabled": false,
										},
