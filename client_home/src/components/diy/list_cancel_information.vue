<template>
	<div class="diy_home diy_list diy_cancel_information" id="diy_cancel_information_list">
		<!-- 列表 -->
		<div class="diy_view_list list list-x" v-if="show">
			<router-link class="diy_card goods diy_list_box_wrap" v-for="(o, i) in list" :key="i"
				:to="'/cancel_information/details?cancel_information_id=' + o['cancel_information_id']">
				<!-- 图片 -->
				<div class="diy_list_img_box" v-if="imgList.length" >
					<div class="diy_row" v-for="(item,index) in imgList" :key="item+index" v-show="$check_field('get',item.name,'/cancel_information/details') && +item.is_img_list">
				...
				<div class="diy_list_item_box">
					<div class="diy_list_item_content" v-for="(item,index) in showItemList" :key="item+index">
						<div class="diy_row" :class="{[item.name]:true}" v-if="$check_field('get',item.name,'/cancel_information/details') && +item.is_img_list">
							<div class="diy_title">
								<span>{{item.title}}:</span>
							</div>
		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
						<th class="diy_title" v-if="$check_field('get','athlete_account')">
						运动员账号
					</th>
							<th class="diy_title" v-if="$check_field('get','athletes')">
						运动员
					</th>
						...
						裁判姓名
							...
							<th class="diy_title" v-if="$check_field('get','number_of_cancellations')">
						取消人数
					</th>
							<th class="diy_title" v-if="$check_field('get','reason_for_cancellation')">
						取消原因
					</th>
					</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
						<td class="diy_field diy_uid" v-if="$check_field('get','athlete_account')">
						<span>
							{{ get_user_name('athlete_account',o['athlete_account']) }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','athletes')">
						<span>
							{{ o["athletes"] }}
						</span>
					</td>
						...
						<span>
							...
							<td class="diy_field diy_number" v-if="$check_field('get','number_of_cancellations')">
						<span>
							{{ o["number_of_cancellations"] }}
						</span>
					</td>
							<td class="diy_field diy_text" v-if="$check_field('get','reason_for_cancellation')">
						<span>
	...
	export default {
		...
		methods: {
			get_user_name(name,id){
				var obj = null;
					if (name == 'athlete_account'){
					obj = this.list_user_athlete_account.getObj({"user_id":id});
				}
