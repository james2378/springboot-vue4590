<template>
	<div class="diy_details_box diy_div_competition_information">
		<div class="warp">
			<div class="container">
				...
				<div class="row">
					...
					<div class="details_btn_wrap">
											<button class="btn btn-primary details_btn" v-if="$check_action('/registration_information/edit','add')" @click="to_form('/registration_information/edit')" > 参赛报名 </button>
											<button class="btn btn-primary details_btn" v-if="$check_action('/competition_information/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/competition_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
...
<script>
	...
	export default {
      ...
      check_collect() {
        var user_id = this.$store.state.user.user_id;
        var competition_information_id = this.obj.competition_information_id;
        this.$get('~/api/collect/count?', {
          user_id,
          source_table: "competition_information",
          source_field: "competition_information_id",
          source_id: competition_information_id
        }, (res) => {
