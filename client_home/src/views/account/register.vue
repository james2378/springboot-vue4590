							...
							<div class="form_register">
								<b-form>
									...
									<b-form-group id="input-group-7" label="身份:" label-for="input-7">
										...
										<!--运动员用户-->
									<form_athlete_users v-if="form.user_group === '运动员用户'" :form="form_sub"></form_athlete_users>
											<!--裁判员用户-->
									<form_referee_user v-if="form.user_group === '裁判员用户'" :form="form_sub"></form_referee_user>
...
<script>
	import mixin from "@/mixins/page.js";
		/* 运动员用户 */
	import form_athlete_users from "@/components/diy/form_athlete_users";
			/* 裁判员用户 */
	import form_referee_user from "@/components/diy/form_referee_user";
